...
plot(myclusGaptxt, main = "Gap Statistic Text Comparison")+
...
plot(myclusGapsem, main = "Gap Statistic Semantic Comparison")+
...
plot(dendtxt)
plot(dendtxt, ylab = "Semantic similarity score", main = "Dendogram of Zebrafish to Zebrafish Text Comparison Scores")
...
plot(dend, ylab = "Semantic similarity score", main = "Dendogram of Zebrafish to Zebrafish Semantic Scores")
...
for (htarget in hgenes[-1]) {
  ...
  if (currscore == htarget){
    ...
    semorthscores = append(semorthscores,tops[znum,1])
  }
...
for (htarget in hgenes[-1]) {
  ...
  txtorthscores = append(semorthscores,tops[1,1])
...
S$captureSemOpt = as.numeric(S$captureSemOpt)
S$captureTxtOpt = as.numeric(S$captureTxtOpt)
...
hist(S$captureSemOpt)
hist(S$captureTxtOpt)
```
...
# orth aves
```{r}
mean(as.data.frame(semorthscores)[,2])
mean(as.data.frame(txtorthscores)[,2])
